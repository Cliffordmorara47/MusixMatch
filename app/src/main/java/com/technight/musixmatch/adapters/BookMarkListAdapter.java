...
public class BookMarkListAdapter extends RecyclerView.Adapter<BookMarkListAdapter.EventViewHolder> {
    ...
    public BookMarkListAdapter(Context context, List<Event> events) {
        mContext = context;
        mEvents = events;
    }

    @Override
    public BookMarkListAdapter.EventViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(BookMarkListAdapter.EventViewHolder holder, int position) {
